...
A document is **vContext Core v0.2 conformant** if:
- It is a single object containing `vContextInfo` and exactly one of `todoList` or `plan`.
- `vContextInfo.version` MUST equal `"0.2"`.
...
vContextInfo: vContextInfo("0.2", "2024-12-27T09:00:00Z", "2024-12-27T10:00:00Z", "America/Los_Angeles")
todoList: TodoList([
  TodoItem(
